...
<body>
    ...
    do { //1.часть кода в "do" обрабатывается первой 
        echo "$i" . "<br>";
        $i++;
        //2.а потом обрабатывается условие
        //если условие false , то выводится "do" и цикл завершается
    ...
    do {
        $a++; // выводит 1
    } while ($a > 10); // 1 не больше 10 поэтому это условие е выводится
    echo $a;
    ?>
</body>
